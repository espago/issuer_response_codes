...
module IssuerResponseCodes
  class TdsCodeTest < Minitest::Test
    def test_humanize_return_proper_value
      ...
      assert code.fraud_notice
      assert code.fraudulent_code?
      assert_equal 'Security failure. Please use a different card or contact issuer. Transactions with this code may be considered fraudulent.',
                   code.humanize
      ...
      assert code.fraud_notice
      assert code.fraudulent_code?
      assert_equal 'Stolen card. Please use a different card or contact issuer. Transactions with this code may be considered fraudulent.',
                   code.humanize
      ...
      assert code.fraud_notice
      assert code.fraudulent_code?
      assert_equal 'Suspected fraud. Please use a different card or contact issuer. Transactions with this code may be considered fraudulent.',
                   code.humanize
    ...
    def test_behaviour_return_proper_value
      ...
      assert code.fraud_notice
      assert code.fraudulent_code?
      assert_equal 'Please use a different card or contact issuer. Transactions with this code may be considered fraudulent.',
                   code.behaviour
