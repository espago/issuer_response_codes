...
module IssuerResponseCodes
  class CodeTest < Minitest::Test
    def test_humanize_return_proper_value
      ...
      assert_equal :en, code.locale
      assert code.fraud_notice
      assert_equal 'Stolen card. Please contact your card issuer to get more details and try again later. IMPORTANT NOTICE: It is forbidden to retry transactions that ended with this code. It may be recognized as fraud attempt!', code.humanize
    ...
    def test_behaviour_return_proper_value
      ...
      assert_equal :en, code.locale
      assert code.fraud_notice
      assert_equal 'Please contact your card issuer to get more details and try again later. IMPORTANT NOTICE: It is forbidden to retry transactions that ended with this code. It may be recognized as fraud attempt!', code.behaviour
    end
