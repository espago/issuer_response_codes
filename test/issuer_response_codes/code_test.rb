...
module IssuerResponseCodes
  class CodeTest < Minitest::Test
    def test_humanize_return_proper_value
      ...
      assert code.fraud_notice
      assert code.fraudulent_code?
      assert_equal 'Invalid transaction. Please use a different card or contact the issuer for clarification. IMPORTANT NOTICE: It is forbidden to retry transactions that ended with this code. It may be recognized as a fraud attempt!',
                   code.humanize
      ...
      assert code.fraud_notice
      assert code.fraudulent_code?
      assert_equal 'Expired card or expiration date is missing. Please use a different card or contact the issuer for clarification. IMPORTANT NOTICE: It is forbidden to retry transactions that ended with this code. It may be recognized as a fraud attempt!',
                   code.humanize
      ...
      assert code.fraud_notice
      assert code.fraudulent_code?
      assert_equal 'Stolen card, pick up (fraud account). Please use a different card or contact the issuer for clarification. IMPORTANT NOTICE: It is forbidden to retry transactions that ended with this code. It may be recognized as a fraud attempt!',
                   code.humanize
      ...
      assert !code.fraud_notice
      assert code.fraudulent_code?
      assert_equal 'Payment rejected by the issuer. Please use a different card or contact the issuer for clarification.',
                   code.humanize
    end
    ...
    def test_behaviour_return_proper_value
      ...
      assert code.fraud_notice
      assert code.fraudulent_code?
      assert_equal 'Please use a different card or contact the issuer for clarification. IMPORTANT NOTICE: It is forbidden to retry transactions that ended with this code. It may be recognized as a fraud attempt!',
                   code.behaviour
    ...
    def test_reason_return_proper_value
      ...
      assert_equal :en, code.locale
      assert code.fraud_notice
      assert_equal 'Transaction rejected due to no response from issuer/bank, inactive Merchant account, used not supported card or incorrect card data.',
                   code.reason
